   ...
   <!-- DEFAULT -->
    ...
    <!-- ADS-START -->
     <!-- ads -->
        ...
        var project_ad_tag = 'longform';
        if ( typeof appConfig.ad_tag !== 'undefined' ) project_ad_tag += '-' + appConfig.ad_tag;
        </script>
        <script>
        if( !is_mobile ) {
...
<header id="rh">
    ...
    <div id="rh-masthead">
        ...
        <div id="rh-center">
            ...
            <a id="rh-front" href="http://www.nydailynews.com/new-york"> New York </a>
        </div>
        <div id="rh-right">
            <div id="rh-ssm">
                <div id="rh-sm">
